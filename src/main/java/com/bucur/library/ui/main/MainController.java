...
import com.bucur.library.ui.main.toolbar.ToolbarController;
...
public class MainController implements Initializable, BookReturnCallback {
    ...
    private void handleMenuAddBook(ActionEvent event) {
        LibraryAssistantUtil.loadWindow(getClass().getResource("/fxml/add_book.fxml"), "Add New Book", null);
    }
    ...
    private void handleAboutMenu(ActionEvent event) {
        LibraryAssistantUtil.loadWindow(getClass().getResource("/fxml/about.fxml"), "About Me", null);
    }
    ...
    private void initComponents() {
        mainTabPane.tabMinWidthProperty().bind(rootAnchorPane.widthProperty()
    ...
    private void handleMenuOverdueNotification(ActionEvent event) {
        LibraryAssistantUtil.loadWindow(getClass().getResource("/fxml/overdue_notification.fxml"), "Notify Users", null);
    }
