...
import com.bucur.library.ui.bookadd.BookAddController;
import com.bucur.library.ui.main.MainController;
import com.bucur.library.ui.memberadd.MemberAddController;
...
public class MemberListController implements Initializable {
    ...
    private void handleMemberEdit(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/member_add.fxml"));
